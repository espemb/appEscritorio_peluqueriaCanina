...
import com.todocode.clientelapelucanina.persistencia.exceptions.NonexistentEntityException;
    ...
    public void edit(Mascota mascota) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                int id = mascota.getNum_cliente(); // Asume que `getNum_cliente()` es el método para obtener el ID
